...
class OtherCategoryDetail extends Component {
    constructor(props) {
        super(props);
        ...
        return (
            <div className="container" >
                <form style={{"width": "350px","verticalAlign": "0%"}} onChange={this.handleChange} className="form" ref = "inputform">
                    ...
                    <label htmlFor="specificCategory">Item's specific category is</label>
                    <input type="text" id="catename" name="catename" placeholder="Item's category name.."></input>
...
export default connect(null, {changeUnsubmittedItem })(OtherCategoryDetail);
