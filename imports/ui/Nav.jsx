                    ...
                    <Toolbar className={''}>
                        ...
                        <nav>
                            <Link variant="button" color="textPrimary" className={classes.link}
                                  onClick={() => this.props.changeChoiceOnNav('home')}>
                                Home &nbsp;
                            </Link>
                            <Link variant="button" color="textPrimary" className={classes.link}
                            ...
                            </Link>
                            {
                                Meteor.userId() ?
                                    <Link variant="button" color="textPrimary" className={classes.link}
                                          onClick={() => this.props.changeChoiceOnNav('post')}>
                                        Post ad &nbsp;
                                    </Link> : null
                            }

                            {Meteor.userId() ? <Link variant="button" color="textPrimary" className={classes.link}
                                                     onClick={() => this.props.changeChoiceOnNav('user')}>
                                My items &nbsp;
                            </Link> : null}
                            {
                                Meteor.userId() ? null :
